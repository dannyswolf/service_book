...
class SetDataSettings:
    def __init__(self, top=None):
        ...
        self.purpose_label.place(relx=0.025, rely=0.180, height=31, relwidth=0.230)
        ...
        self.purpose_combobox.place(relx=0.27, rely=0.180, height=31, relwidth=0.600)
        ...
        self.del_purpose_btn.place(relx=0.900, rely=0.180, height=30, relwidth=0.080)
        ...
        # Ενέργειες
        # self.actions_big_label = tk.Label(self.root)
        # self.actions_big_label.place(relx=0.025, rely=0.350, height=25, relwidth=0.960)
        # self.actions_big_label.configure(activebackground="#f9f9f9")
        # self.actions_big_label.configure(activeforeground="black")
        # self.actions_big_label.configure(background="#006291")
        # self.actions_big_label.configure(disabledforeground="#a3a3a3")
        # self.actions_big_label.configure(font="-family {Calibri} -size 10 -weight bold")
        # self.actions_big_label.configure(foreground="#ffffff")
        # self.actions_big_label.configure(highlightbackground="#d9d9d9")
        # self.actions_big_label.configure(highlightcolor="black")
        # self.actions_big_label.configure(relief="groove")
        # self.actions_big_label.configure(text='''Ενέργειες''')

        self.actions_label = tk.Label(self.root)
        self.actions_label.place(relx=0.025, rely=0.480, height=31, relwidth=0.230)
        ...
        self.actions_combobox.place(relx=0.27, rely=0.480, height=31, relwidth=0.600)
        self.actions_combobox.configure(values=self.actions)
        # self.purpose_combobox.configure(state="readonly")
        # self.purpose_combobox.bind("<<ComboboxSelected>>", self.show_purposes_details)
        self.del_actions_btn = tk.Button(self.root)
        self.del_actions_btn.place(relx=0.900, rely=0.480, height=30, relwidth=0.080)
        ...
        self.save_btn.place(relx=0.350, rely=0.700, height="30", relwidth=0.200)
