...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        self.customer_frame.configure(background="#d9d9d9")
        ...
        self.copier_frame.configure(background="#d9d9d9")
        ...
        self.copier_search_entry.place(relx=0.022, rely=0.100, height=20, relwidth=0.188)
