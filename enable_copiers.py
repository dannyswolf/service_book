...
class enable_copiers_window:
    def __init__(self, top=None):
        ...
        self.Label2.configure(text='''Ενεργοποίηση μηχανήματος''')
        ...
        self.select_copier_label.configure(background="#6b6b6b")
        ...
        self.select_copier_label.configure(text='''Επιλογή μηχανήματος''')
