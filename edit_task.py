...
class edit_task_window:
    ...
    # Προσθήκη αρχείων
    def add_files(self):
        # αν ο πελάτης δεν ειναι στο συστημα
    ...
    def del_spare_parts(self):
        ...
        except UnboundLocalError:  # Όταν το ανταλλακτικό δεν είναι στην αποθήκη
            pass
        try:
    ...
    def print_to_pdf(self):
        ...
        outputFilename = f'{prints_dir}/Service_Book_' + f"{self.customer_entry.get()}".replace(" ", "_") + '.pdf'
